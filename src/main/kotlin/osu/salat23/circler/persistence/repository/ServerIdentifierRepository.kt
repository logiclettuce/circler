...
interface ServerIdentifierRepository : JpaRepository<ServerIdentifier,  Long> {
    ...
    fun getPlayerIdentifierId(userId: String, chatId: String, @Param("server") server: Command.Server): String?
    ...
    fun setPlayerIdentifier(userId: String, chatId: String, @Param("server") server: Command.Server)
